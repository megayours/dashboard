...
const BattleGame = ({chain, amoyContract, tokenId, owner}: {chain: string, amoyContract: string, tokenId: number, owner: string}) => {
    const { battleGameData, isLoading } = useBattleGameData({chain, amoyContract, tokenId, owner});
    ...
    return <div className="container mx-auto space-y-4">
        ...
        <div className="container mx-auto">
            <div className="flex flex-col space-y-2">
                ...
                {battleHistory && battleHistory.map((battle: any) => (
